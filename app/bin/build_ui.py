...
print("<Script for Building Control Center GUI>")
parser = argparse.ArgumentParser()
parser.add_argument("--force", help="force building of all .ui files", action="store_true")
args = parser.parse_args()
script_dir = os.path.dirname(os.path.realpath(__file__))
project_source_dir = os.path.join(script_dir, os.path.pardir, "controlcenter")
...
for entry in os.scandir(resources_dir):
    if entry.is_file():
        ...
        if extension == ".qrc":
            ...
            output_path = os.path.join(project_source_dir, "ui", output_name)
